...
namespace ITCommunity
{
    ...
    public static class AppCache
    {
        ...
        /// 
        /// Метод пытется гарантировать(я не гарантирую) что только один поток отправится 
        /// в базу данных за данными.
        /// 
        /// Курево - http://habrahabr.ru/blogs/net/61617/
        /// </summary>
        /// <param name="key">Идентификатор</param>
        /// <param name="lock">Нужен для гарантии, передавайтеr к примеру "new object()"</param>
