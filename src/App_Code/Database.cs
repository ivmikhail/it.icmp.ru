...
namespace ITCommunity {
	public class Database {
		private static SqlConnection OpenConnection() {
			SqlConnection connection = new SqlConnection(Global.GetConnectionString());
			connection.Open();
			return connection;
		}
		...
		public static DataTable CommentGetByAuthor(Int32 author_id, Int32 page, Int32 count, ref Int32 total_records) {
			SqlConnection connection = OpenConnection();
			System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand("CommentGetByAuthor", connection);
			cmd.CommandType = System.Data.CommandType.StoredProcedure;
			...
			cmd.Parameters.Add("@total_records", System.Data.SqlDbType.Int, 0);
			cmd.Parameters["@total_records"].Direction = System.Data.ParameterDirection.InputOutput;
			cmd.Parameters["@total_records"].Value = total_records;
			System.Data.SqlClient.SqlDataReader reader = cmd.ExecuteReader();
			System.Data.DataTable table = new DataTable();
			...
			reader.Close();
			DataTable result = table; total_records = (Int32)(cmd.Parameters["@total_records"].Value);
			connection.Close();
			return result;
		}
		public static DataRow CommentGetById(Int32 id) {
			SqlConnection connection = OpenConnection();
			System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand("CommentGetById", connection);
			cmd.CommandType = System.Data.CommandType.StoredProcedure;
		...
		public static int CommentUpdate(Int32 id, String text) {
			SqlConnection connection = OpenConnection();
			System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand("CommentUpdate", connection);
			cmd.CommandType = System.Data.CommandType.StoredProcedure;
		...
		public static DataRow HeaderTextAdd(Int32 user_id, String text) {
			...
			cmd.Parameters["@user_id"].Direction = System.Data.ParameterDirection.Input;
			cmd.Parameters["@user_id"].Value = user_id;
			cmd.Parameters.Add("@text", System.Data.SqlDbType.NVarChar, 128);
			cmd.Parameters["@text"].Direction = System.Data.ParameterDirection.Input;
			cmd.Parameters["@text"].Value = text;
			System.Data.SqlClient.SqlDataReader reader = cmd.ExecuteReader();
			System.Data.DataTable table = new DataTable();
		...
		public static int HeaderTextDel(Int32 id) {
			SqlConnection connection = OpenConnection();
			System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand("HeaderTextDel", connection);
			cmd.CommandType = System.Data.CommandType.StoredProcedure;
		...
		public static DataTable HeaderTextGet(Int32 page, Int32 count, ref Int32 records_count) {
			SqlConnection connection = OpenConnection();
			System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand("HeaderTextGet", connection);
			cmd.CommandType = System.Data.CommandType.StoredProcedure;
			...
			cmd.Parameters["@count"].Direction = System.Data.ParameterDirection.Input;
			cmd.Parameters["@count"].Value = count;
			cmd.Parameters.Add("@records_count", System.Data.SqlDbType.Int, 0);
			cmd.Parameters["@records_count"].Direction = System.Data.ParameterDirection.InputOutput;
			cmd.Parameters["@records_count"].Value = records_count;
			System.Data.SqlClient.SqlDataReader reader = cmd.ExecuteReader();
			System.Data.DataTable table = new DataTable();
			...
			reader.Close();
			DataTable result = table; records_count = (Int32)(cmd.Parameters["@records_count"].Value);
			connection.Close();
			return result;
		}
		...
		public static int HeaderTextUpdateShowBeginDate(Int32 id) {
			SqlConnection connection = OpenConnection();
			System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand("HeaderTextUpdateShowBeginDate", connection);
			cmd.CommandType = System.Data.CommandType.StoredProcedure;
		...
		public static int HeaderTextUpdateShowEndDate(Int32 id) {
			SqlConnection connection = OpenConnection();
			System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand("HeaderTextUpdateShowEndDate", connection);
			cmd.CommandType = System.Data.CommandType.StoredProcedure;
		...
		public static DataTable PostGetByAuthor(Int32 page, Int32 count, Int32 author_id, ref Int32 posts_count) {
			SqlConnection connection = OpenConnection();
			System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand("PostGetByAuthor", connection);
			cmd.CommandType = System.Data.CommandType.StoredProcedure;
		...
		public static DataTable PostGetTopByViews(Int32 period, Int32 count) {
			SqlConnection connection = OpenConnection();
			System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand("PostGetTopByViews", connection);
			cmd.CommandType = System.Data.CommandType.StoredProcedure;
		...
		public static DataRow RatingAdd(Int32 entity_id, Int32 entity_type, Int32 value) {
			SqlConnection connection = OpenConnection();
			System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand("RatingAdd", connection);
			cmd.CommandType = System.Data.CommandType.StoredProcedure;
			...
			cmd.Parameters.Add("@value", System.Data.SqlDbType.Int, 0);
			cmd.Parameters["@value"].Direction = System.Data.ParameterDirection.Input;
		...
		public static DataRow RatingGetByEntity(Int32 entity_id, Int32 entity_type) {
			SqlConnection connection = OpenConnection();
			System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand("RatingGetByEntity", connection);
			cmd.CommandType = System.Data.CommandType.StoredProcedure;
		...
		public static DataRow RatingLogAdd(Int32 entity_id, Int32 entity_type, Int32 user_id, Int32 value) {
			SqlConnection connection = OpenConnection();
			System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand("RatingLogAdd", connection);
			cmd.CommandType = System.Data.CommandType.StoredProcedure;
		...
		public static int RatingUpdateValue(Int32 id, Int32 value) {
			...
			cmd.Parameters.Add("@value", System.Data.SqlDbType.Int, 0);
			cmd.Parameters["@value"].Direction = System.Data.ParameterDirection.Input;
			cmd.Parameters["@value"].Value = value; int result = cmd.ExecuteNonQuery();
			connection.Close();
			return result;
		}
		...
		public static int RecoveryPurgeOldTasks() {
			SqlConnection connection = OpenConnection();
			System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand("RecoveryPurgeOldTasks", connection);
			cmd.CommandType = System.Data.CommandType.StoredProcedure;
		...
		public static DataTable UserGetBlocked() {
			SqlConnection connection = OpenConnection();
			System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand("UserGetBlocked", connection);
			cmd.CommandType = System.Data.CommandType.StoredProcedure;
		...
		public static DataTable UserGetLastTopPosters(Int32 count, Int32 days) {
			SqlConnection connection = OpenConnection();
			System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand("UserGetLastTopPosters", connection);
			cmd.CommandType = System.Data.CommandType.StoredProcedure;

			cmd.Parameters.Add("@count", System.Data.SqlDbType.Int, 0);
			cmd.Parameters["@count"].Direction = System.Data.ParameterDirection.Input;
			cmd.Parameters["@count"].Value = count;
			cmd.Parameters.Add("@days", System.Data.SqlDbType.Int, 0);
			cmd.Parameters["@days"].Direction = System.Data.ParameterDirection.Input;
		...
		public static DataRow UserUpdate(Int32 user_id, String pass, Byte role, String email, Byte can_add_header_text, Int32 header_text_counter) {
			...
			cmd.Parameters["@email"].Direction = System.Data.ParameterDirection.Input;
			cmd.Parameters["@email"].Value = email;
			cmd.Parameters.Add("@can_add_header_text", System.Data.SqlDbType.TinyInt, 0);
			cmd.Parameters["@can_add_header_text"].Direction = System.Data.ParameterDirection.Input;
			cmd.Parameters["@can_add_header_text"].Value = can_add_header_text;
			cmd.Parameters.Add("@header_text_counter", System.Data.SqlDbType.Int, 0);
			cmd.Parameters["@header_text_counter"].Direction = System.Data.ParameterDirection.Input;
			cmd.Parameters["@header_text_counter"].Value = header_text_counter;
			System.Data.SqlClient.SqlDataReader reader = cmd.ExecuteReader();
			System.Data.DataTable table = new DataTable();
