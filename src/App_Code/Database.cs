...
namespace ITCommunity {
	public class Database {
		...
		public static int PollGetNext(Int32 id) {
			SqlConnection connection = OpenConnection();
		...
		public static object UserGetPostsCount(Int32 user_id) {
			SqlConnection connection = OpenConnection();
			System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand("UserGetPostsCount", connection);
			cmd.CommandType = System.Data.CommandType.StoredProcedure;

			cmd.Parameters.Add("@user_id", System.Data.SqlDbType.Int, 0);
			cmd.Parameters["@user_id"].Direction = System.Data.ParameterDirection.Input;
			cmd.Parameters["@user_id"].Value = user_id; object result = cmd.ExecuteScalar();
			connection.Close();
			return result;
		}
