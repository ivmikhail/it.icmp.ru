...
<div id="add_post">
    <ul class="list">
        ...
        <li>        
            <h2>Текст новости</h2>  
            <p class="note">                   
                Описание и текст разделяется разделителем(&lt;hr /&gt;). Если разделитель не вставите, то на главной появится весь текст новости, иначе только описание. Для форматирования используйте html-теги.
            </p>
