...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="server">
	...
	<div id="edit-post">
		...
		<h2>Текст новости</h2>
		<div class="note">
			Описание и текст разделяется разделителем(<b>[hr]</b>). Если разделитель не вставите, то на главной появится весь текст новости, иначе только описание.
		</div>
		...
		<div class="note">
			Нажимая кнопку добавить, вы соглашаетесь с <a href="http://it.icmp.ru:3000/wiki/itc/Правила_постинга" title="Правила постинга">правилами</a>
		</div>
