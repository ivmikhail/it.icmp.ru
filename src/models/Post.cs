...
namespace ITCommunity.Models
{
    ...
    public class Post
    {
        ...
        {
            get { return BBCodeParser.Format(HttpUtility.HtmlEncode(_description)); }
        }
        ...
        {
            get { return BBCodeParser.Format(HttpUtility.HtmlEncode(_text)); }
        }
        ...
        {
            get { return HttpUtility.HtmlEncode(_title); }
        }
