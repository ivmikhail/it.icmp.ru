...
<div id="rfc-search">
    ...
    <asp:TextBox ID="TextBoxSearch" runat="server" /> <asp:LinkButton ID="LinkButtonSearch" runat="server" OnClick="LinkButtonSearch_Click">Искать</asp:LinkButton>
    <asp:RequiredFieldValidator ID="SearchRequiredFieldValidator" runat="server" ErrorMessage="Введите чего-нибудь" ControlToValidate="TextBoxSearch" />
</div> 
