	...
	<div id="structure-tabs" class="tabs">
		...
		<div class="sections">
			<div class="panel">
				...
				<br />
				<asp:GridView ID="gv_categories" runat="server" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="Id" DataSourceID="SqlDataSourceCategories" PageSize="20" EnableSortingAndPagingCallbacks="True" CellSpacing="5" CssClass="data-table">
						<Columns>         
			...
			<div class="panel">
				<h2>Добавить пункт в меню</h2>
					...
					<asp:GridView ID="gv_menuitems" runat="server" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="id" DataSourceID="SqlDataSourceMenu" PageSize="20" EnableSortingAndPagingCallbacks="True" CellSpacing="5" CssClass="data-table">
						<Columns>
